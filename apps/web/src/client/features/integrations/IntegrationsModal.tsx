...
// Account-menu → Integrations settings. Connect Linear by pasting a personal API key (server
// validates + encrypts it). Mirrors the Shortcuts overlay shell. Mounted once in App.
export default function IntegrationsModal(props: { open: boolean; onClose: () => void }) {
  const qc = useQueryClient()
  const status = createQuery(() => integrationsOptions(props.open))
